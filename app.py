...
# কনফিগারেশন - BASE_DIR ব্যবহার করুন
...
def run_code():
    ...
    # সঠিক পাথ তৈরি করুন - শুধু ইউজার ফোল্ডার থেকে
    user_folder = os.path.join(UPLOAD_FOLDER, username)
    filepath = os.path.join(user_folder, filename)
    
    print(f"Looking for file at: {filepath}")  # ডিবাগিং এর জন্য
    ...
    try:
        ...
        def run_script():
            try:
                # ফাইলটি সঠিক লোকেশনে রান করুন
                process = subprocess.Popen(
                    [sys.executable, filepath],
                    stdout=subprocess.PIPE,
                    stderr=subprocess.PIPE,
                    text=True,
                    cwd=user_folder  # ইউজারের ফোল্ডারে কাজ করুন
                )
