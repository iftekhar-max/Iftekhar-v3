...
def run_code():
    ...
    try:
        ...
        def run_script(username, filename, user_folder, process_id):
            try:
        ...
        thread = threading.Thread(target=run_script, args=(username, filename, user_folder, process_id))
        thread.daemon = True
        thread.start()
